-- Migration: move report pricing to sack-based model (UGX 2,000 per sack)
...
-- Recompute amount from sack count using UGX 2,000 per sack.
UPDATE garbage_reports
SET payment_amount = sack_count * 2000
